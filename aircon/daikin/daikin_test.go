...
func TestState_Encode(t *testing.T) {
	successfulEncodeTests := []struct {
	...
	}{
		{
			...
			expectedp1: []byte{
				0x11, 0xda, 0x27, 0x0, 0x1, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x13,
			},
			expectedp2: []byte{
				0x11, 0xda, 0x27, 0x0, 0x0, 0x8, 0x24, 0x0, 0xa0, 0x0, 0x0, 0x6, 0x60, 0x0, 0x0, 0xc1, 0x90, 0x0, 0x95,
			},
		},
	}
